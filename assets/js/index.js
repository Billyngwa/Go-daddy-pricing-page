...
//     if(whatIsAbsolute.style.display=='none'){
...
//     if(howDoAbsolute.style.display=='none'){
//         howDoAbsolute.style.display = 'block';
//     }else{
...
//     if(iHaveAbsolute.style.display=='none'){
//         iHaveAbsolute.style.display = 'block';
//     }else{
//         iHaveAbsolute.style.display ='none';
//     }
// })
...
//     if(domainPrivacyAbsolute.style.display=='none'){
//         domainPrivacyAbsolute.style.display = 'block';
//     }else{
//         domainPrivacyAbsolute.style.display ='none';
//     }
// })
...
//     if(howManyAbsolute.style.display=='none'){
//         howManyAbsolute.style.display = 'block';
//     }else{
//         howManyAbsolute.style.display ='none';
//     }
// })
...
//     if(canIAbsolute.style.display=='none'){
//         canIAbsolute.style.display = 'block';
//     }else{
//         canIAbsolute.style.display ='none';
//     }
// })
...
//     if(howMuchAbsolute.style.display=='none'){
//         howMuchAbsolute.style.display = 'block';
//     }else{
//         howMuchAbsolute.style.display ='none';
//     }
// })
...
//     if(bestDomainAbsolute.style.display=='none'){
//         bestDomainAbsolute.style.display = 'block';
//     }else{
//         bestDomainAbsolute.style.display ='none';
//     }
// })
...
//     if(alreadyTakenAbsolute.style.display=='none'){
//         alreadyTakenAbsolute.style.display = 'block';
//     }else{
//         alreadyTakenAbsolute.style.display ='none';
//     }
// })
...
//     if(registerMoreAbsolute.style.display=='none'){
//         registerMoreAbsolute.style.display = 'block';
//     }else{
//         registerMoreAbsolute.style.display ='none';
//     }
// })

// // section 4 slow motion dropdown
...
var domains = document.getElementById('domain');
var domainsIcon = document.getElementById('first_chevron');
var domainAbsolute = document.getElementById('domain_absolute');
domains.addEventListener('click', function(){
    if(domainAbsolute.className.split(' ').includes('active')){
        console.log('true');
        domainAbsolute.style.maxHeight = null;

        domainAbsolute.className = domainAbsolute.className.replace(' active', "");
        domainsIcon.style.transform = 'rotate(270deg)';
        domainsIcon.style.color = 'black';


    }else{
        // howDoAbsolute.style.display ='none';
        howDoAbsolute.className += ' active';
        domainAbsolute.style.maxHeight = domainPrivacyAbsolute.scrollHeight + 'px';
        domainAbsolute.style.transform = 'rotate(360deg)';
        domainsIcon.style.color = '#e24747';
    }
})